...
class BackstagePassQualityUpdateJobTest < ActiveSupport::TestCase
  def test_depreciation_well_before_sell_date
    item = Item.new(sell_in: 11, quality: 10, name: "Backstage pass to a TAFKAL80ETC concert")
  ...
  def test_depreciation_medium_close_to_sell_date_upper_bound
    item = Item.new(sell_in: 10, quality: 10, name: "Backstage pass to a TAFKAL80ETC concert")
    job = BackstagePassQualityUpdateJob.new
  ...
  def test_depreciation_medium_close_to_sell_date_lower_bound
    item = Item.new(sell_in: 6, quality: 10, name: "Backstage pass to a TAFKAL80ETC concert")
    job = BackstagePassQualityUpdateJob.new
  ...
  def test_depreciation_very_close_to_sell_date_upper_bound
    item = Item.new(sell_in: 5, quality: 10, name: "Backstage pass to a TAFKAL80ETC concert")
    job = BackstagePassQualityUpdateJob.new
  ...
  def test_depreciation_very_close_to_sell_date_lower_bound
    item = Item.new(sell_in: 1, quality: 10, name: "Backstage pass to a TAFKAL80ETC concert")
    job = BackstagePassQualityUpdateJob.new
  ...
  def test_depreciation_on_sell_date
    item = Item.new(sell_in: 0, quality: 10, name: "Backstage pass to a TAFKAL80ETC concert")
    job = BackstagePassQualityUpdateJob.new
  ...
  def test_depreciation_after_sell_date
    item = Item.new(sell_in: 0, quality: 0, name: "Backstage pass to a TAFKAL80ETC concert")
    job = BackstagePassQualityUpdateJob.new
